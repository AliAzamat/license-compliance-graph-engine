"""Thin connection-pool wrapper. The graph repository is the only caller that
runs raw SQL; nothing above it sees a cursor."""
...
DSN = os.environ.get("DATABASE_URL", "postgresql://localhost/compliance")
